...
{
    /// <inheritdoc />
    public partial class add_mgr_rentacarprocess : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentACarProcess_Locations_DropOffLocationId",
                        column: x => x.DropOffLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_RentACarProcess_Locations_PickUpLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentACarProcess_DropOffLocationId",
                table: "RentACarProcess",
                column: "DropOffLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_RentACarProcess_PickUpLocationId",
                table: "RentACarProcess",
